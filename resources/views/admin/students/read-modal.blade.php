...
<div class="flex justify-between mb-4 rounded-t sm:mb-5">
    <div class="text-lg text-gray-900 md:text-xl dark:text-white">
        ...
        <p class="font-bold">{{ $student->classroom->name}}</p>
    </div>
    <div>
...
<dl>
    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Email</dt><dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $student->email }}</dd>
    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Gender</dt><dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $student->gender }}</dd>
    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Birthday</dt><dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $student->birthday }}</dd>
    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Address</dt><dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $student->address }}</dd>
</dl>
