    ...
    <nav class="bg-gray-800">
                        ...
                        <el-dropdown class="relative ml-3">
                            ...
                            <el-menu anchor="bottom end" popover
                                ...
                                <form method="POST" action="{{ route('auth.logout') }}" id="logout-form-desktop">
                                    @csrf
                                    <button type="submit"
                                        class="block w-full text-left px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-hidden">
                                        Sign out
                                    </button>
                                </form>
                            </el-menu>
        ...
        <el-disclosure id="mobile-menu" hidden class="block md:hidden">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                <x-nav-link-mobile href="/contact" :active="request()->is('contact')">
                    Contact
                </x-nav-link-mobile>
                <x-nav-link-mobile href="/students" :active="request()->is('student')">
                    Students
                </x-nav-link-mobile>
                <x-nav-link-mobile href="/guardians" :active="request()->is('guardians')">
                    Guardians
                </x-nav-link-mobile>
                <x-nav-link-mobile href="/classrooms" :active="request()->is('classrooms')">
                    Classrooms
                </x-nav-link-mobile>
                <x-nav-link-mobile href="/teacher" :active="request()->is('teacher')">
                    Teacher
                </x-nav-link-mobile>
                <x-nav-link-mobile href="/subject" :active="request()->is('subject')">
                    Subject
                </x-nav-link-mobile>
            </div>
